...
app.config['MAIL_USERNAME'] = 'bbhavya_be22@thapar.edu'  # my email
app.config['MAIL_PASSWORD'] = 'omxm paxy ggey woqz'  # my app password
app.config['MAIL_DEFAULT_SENDER'] = 'bbhavya_be22@thapar.edu'  # my email
mail = Mail(app)
